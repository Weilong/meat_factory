...
<div class="invoice">
    <p><h1>Tax Invoice</h1></p>
   	<div class="invoice_head"> 
        <div id="client_info">
            <p>Account Name: <?php echo $account?></p>
            <p>Telephone: <?php echo $phone?></p>
            <p>Fax: <?php echo $fax?></p>
            <p>Service Address: <?php echo $address?></p>
        </div>
        <div id="invoice_info">
                ...
                <p>Invoice Date:	<?php echo $invoicedate?></p></strong>
        </div>
    </div>
    <div id="invoice_detail">
        <table id="invoice_detail" border='1'>
            ...
            <tr><td align="right" colspan="4">Amount: <?php echo $amount?></td></tr>
        </table>
    </div>
    <div id="invoice_footer">
        ...
        <br/>
        <p>Invoice number: <?php echo $invoiceid?></p>
        <p>Tax invoice-date issued: <?php echo date('Y-m-d')?></p>
    </div>
</div>
</body>
